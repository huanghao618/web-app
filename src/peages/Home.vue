    ...
    >
      ...
      >
        ...
        <div
          ...
          :key="i"
        >
          <Good :good="list[2 * (i - 1)]" />
          <Good :good="list[2 * (i - 1) + 1]" />
        </div>
      </van-list>
    </van-pull-refresh>
...
<script>
import { NoticeBar, Search, Image, Swipe, SwipeItem, Divider, Tabbar, TabbarItem, PullRefresh, List, Toast } from 'vant';
export default {
  name: 'Home',
  //  转换为局部组件并进行异步加载
  components: {
